 ...
 */
public class SettingsActivityOld extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar actionbar = (Toolbar) findViewById(R.id.toolbar_settings);
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            FitWindowsLinearLayout root = (FitWindowsLinearLayout) findViewById(android.R.id.list).getParent().getParent().getParent();
            bar = (Toolbar) LayoutInflater.from(this).inflate(R.layout.settings_toolbar_layout, root, false);
